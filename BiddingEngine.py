...
def exeLogisticRegressionBidModel(validationData=None, trainData=None, writeResult2CSV=False):
    ...
    lrBidModel=LogisticRegressionBidModel.LogisticRegressionBidModel(regressionFormulaY='click', regressionFormulaX=final_x,cBudget=272.412385*1000, avgCTR=0.2)
    print(type(validationData))
    lrBidModel.trainModel(trainData, retrain=True)
